...
const ProjectCard: FC<Props> = ({
	...
	if (layout === 0) {
		return (
			<>
				<div className="col-span-10 md:col-span-5 col-start-2 mt-16 flex w-full md:w-[96%] flex-col items-start justify-center">
		...
		return (
			<>
				<div className="col-span-10 md:col-span-5 col-start-2 mt-16 w-full md:w-[96%] hidden md:block">
					<Image src={src} quality={100} className="w-full" />
				</div>
